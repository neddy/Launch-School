...
def interest_rate
  rate = ''
  prompt("Please enter the interest rate. You can enter an interst rate with up to 2 decimal places. eg: 5.55 (Please exclude the '%' sign.)")
  loop do
    loop do
      rate = gets.chomp
...
def loan_duration
  ...
  loop do
    ...
    loop do
      ...
      break if years == ''
      prompt("Please only enter whole numbers, without any symbols or letters. Please try again...")
    end
    loop do
