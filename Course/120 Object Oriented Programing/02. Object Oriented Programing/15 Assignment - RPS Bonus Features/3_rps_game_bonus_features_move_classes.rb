# rps_game_bonus_features_move_classes.rb

# Moving the moves into seperate classes was not a good design choice as it made the code longer and redundant as the only thing that really changes between the classes was the value.
...
class Human < Player
  ...
  def choose
    ...
    self.move = case Move::VALID_CHOICES[choice]
                when 'rock'
                  Rock.new
                when 'paper'
                  Paper.new
...
class Computer < Player
  ...
  def choose
    self.move = case Move::VALID_CHOICES.values.sample
                when 'rock'
                  Rock.new
                when 'paper'
                  Paper.new
